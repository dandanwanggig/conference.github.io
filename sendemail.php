<?php
    ...
    $to_email       = "dandanwang0614@gmail.com";
...
die($output);
    ...
    $headers = "From: AV Square Technologies <info@avsquaretechnologies.com>" . $eol;
    ...
    if(!$send_mail)
    {
        ...
        $output = json_encode(array('type'=>'error', 'text' => 'Could not submit! '));
        die($output);
    }else{
        $output = json_encode(array('type'=>'message', 'text' => 'Hi '.$first_name .' Thank you for your submission, will get back to you shortly'));
        die($output);
    }
